...
from illuvutar.engine.entities.components import Position, Sprite, Health, PhysicsComponent
...
def test_physics_system_applies_move(store, passability):
    from illuvutar.engine.systems.physics_system import MoveIntent as PMI
